...
public class HomeworkDatabase {
  ...
  public ArrayList<HomeworkItem> getAllHomeworks() {
    ...
    for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
      HomeworkItem h = new HomeworkItem(c.getInt(id), c.getString(iTitle), c.getString(iSub),
              ...
              getAlarmsForHomework(c.getInt(id)));
      hwks.add(h);
    }
  ...
  public void deleteAlarm(int alarmID) {
    ourDatabase.delete(DATABASE_ALARM_TABLE, KEY_ALARM_ID + " = " + alarmID, null);
  }

  public ArrayList<HomeworkAlarm> getAlarmsForHomework(int homeworkID) {
    ArrayList<HomeworkAlarm> alarms = getAllAlarms();
  ...
  public ArrayList<HomeworkAlarm> getAllAlarms() {
